...
tf.flags.DEFINE_integer("save_freq", 10, "save model every save_freq steps, 0 to disable")
...
tf.flags.DEFINE_float("gene_p_style_loss_weight", 100., "the weight of preceptual style loss in generator loss")
